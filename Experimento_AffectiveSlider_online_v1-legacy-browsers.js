...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'Estimulos/caixa de oculos.png', 'path': 'Estimulos/caixa de oculos.png'},
    ...
    {'name': 'Estimulos/cubo magico.png', 'path': 'Estimulos/cubo magico.png'},
    {'name': 'Estimulos/carro de brinquedo pequeno.png', 'path': 'Estimulos/carro de brinquedo pequeno.png'},
    {'name': 'Estimulos/mamadeira media.png', 'path': 'Estimulos/mamadeira media.png'},
    ...
    {'name': 'Estimulos/copo de bebe.png', 'path': 'Estimulos/copo de bebe.png'},
    ...
    {'name': 'Estimulos/mao humana dissecada 1.png', 'path': 'Estimulos/mao humana dissecada 1.png'},
    ...
    {'name': 'Estimulos/caixa de fosforos.png', 'path': 'Estimulos/caixa de fosforos.png'},
    {'name': 'Estimulos/aranha.png', 'path': 'Estimulos/aranha.png'},
    {'name': 'Estimulos/otoscopio.png', 'path': 'Estimulos/otoscopio.png'},
    ...
    {'name': 'Estimulos/pao sujo.png', 'path': 'Estimulos/pao sujo.png'},
    {'name': 'Estimulos/escova de dentes rosa.png', 'path': 'Estimulos/escova de dentes rosa.png'},
    {'name': 'Estimulos/chinelo de bebe.png', 'path': 'Estimulos/chinelo de bebe.png'},
    {'name': 'Estimulos/tampa de metal.png', 'path': 'Estimulos/tampa de metal.png'},
    {'name': 'Estimulos/cadeado.png', 'path': 'Estimulos/cadeado.png'},
    {'name': 'Estimulos/relogio touchscreen.png', 'path': 'Estimulos/relogio touchscreen.png'},
    ...
    {'name': 'Estimulos/coracao cortado.png', 'path': 'Estimulos/coracao cortado.png'},
    ...
    {'name': 'Estimulos/maca.png', 'path': 'Estimulos/maca.png'},
    ...
    {'name': 'Estimulos/mao humana.png', 'path': 'Estimulos/mao humana.png'},
    {'name': 'Estimulos/chiclete com cabelo.png', 'path': 'Estimulos/chiclete com cabelo.png'},
    {'name': 'Estimulos/coracao.png', 'path': 'Estimulos/coracao.png'},
    {'name': 'Estimulos/bolha de sabao.png', 'path': 'Estimulos/bolha de sabao.png'},
    ...
    {'name': 'Estimulos/lapis rosa.png', 'path': 'Estimulos/lapis rosa.png'},
    ...
    {'name': 'Estimulos/termometro.png', 'path': 'Estimulos/termometro.png'},
    ...
    {'name': 'Estimulos/dedo esqueletico.png', 'path': 'Estimulos/dedo esqueletico.png'},
    ...
    {'name': 'Estimulos/taca quebrada.png', 'path': 'Estimulos/taca quebrada.png'},
    ...
    {'name': 'Estimulos/lampada.png', 'path': 'Estimulos/lampada.png'},
    {'name': 'Estimulos/adaptador de tomada.png', 'path': 'Estimulos/adaptador de tomada.png'},
    {'name': 'Estimulos/frasco de remedio.png', 'path': 'Estimulos/frasco de remedio.png'},
...
function Tela_inicialRoutineBegin(snapshot) {
  return async function () {
    ...
    Tela_inicialComponents.forEach( function(thisComponent) {
...
function visao_geralRoutineBegin(snapshot) {
  return async function () {
    ...
    visao_geralComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instrucoes_tarefaRoutineBegin(snapshot) {
  return async function () {
    ...
    Instrucoes_tarefaComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Iniciar_treinamentoRoutineBegin(snapshot) {
  return async function () {
    ...
    Iniciar_treinamentoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Iniciar_experimentoRoutineBegin(snapshot) {
  return async function () {
    ...
    Iniciar_experimentoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function engajamentoRoutineBegin(snapshot) {
  return async function () {
    ...
    engajamentoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Tela_FinalRoutineBegin(snapshot) {
  return async function () {
    ...
    Tela_FinalComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
